...
<style>
    ...
    @media (max-width: 1000px) {
        ...
        .block-container {
            padding-top: calc(56px + env(safe-area-inset-top, 0px) - 220px) !important;
...
<div class="ios-top-bar-wrapper">
  <div class="ios-nav-bar">
    ...
    <div class="ios-nav-center">
      ...
      <div class="ios-nav-subtitle">{today_label} · v16</div>
    </div>
...
with col_side:
    ...
    <div class="control-panel-card">
        <div>
            ...
            <div style="font-size: 13px; color: #6B7B8D; margin-top: 5px;">{today_label} · v16</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
